                   ...
                   const char *username, const char *password)
{
	...
	/*
	 * FIXME: Since Mosquitto accepts client connections without authentication
	 * to ease communication with locally running applications, we must not usually
	 + bind to ANY (as is the default).
	 * Instead, bind to localhost and to ANY only on debug builds.
	 * This may require a new configure parameter, though.
	 */
	fprintf(fout,
	        "# AUTOGENERATED BY %s\n"
